...
public class ClassCompareUtil {
     ...
     */
    public static Map<String, Map<String,Object>>  compareObject(CompareDTO compareDTO) {
        Map<String, Map<String,Object>> resultMap=compareFields(compareDTO.getOldObject(),compareDTO.getNewObject());
        System.out.println(resultMap.get("brandId").get("oldObject"));
        System.out.println("-----------------------");
            return resultMap;
